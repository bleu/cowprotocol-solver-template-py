...
class ConstantProductPool:
    ...
    def get_amount_out(self, token_in: str, amount_in: int) -> Optional[Tuple[str, int]]:
    ...
    def get_amount_in(self, token_out: str, amount_out: int) -> Optional[Tuple[str, int]]:
...
class WeightedProductPool:
    ...
    def get_amount_out(self, token_in: str, token_out: str, amount_in: int) -> Optional[int]:
    ...
    def get_amount_in(self, token_out: str, token_in: str, amount_out: int) -> Optional[int]:
...
class PoolHandler:
    ...
    def __init__(self):
        ...
        self.pools: Dict[str, Union[ConstantProductPool, WeightedProductPool, StablePool]] = {}
    ...
    def _parse_constant_product(self, liquidity: Liquidity) -> Optional[ConstantProductPool]:
    ...
    def _parse_weighted_product(self, liquidity: Liquidity) -> Optional[WeightedProductPool]:
