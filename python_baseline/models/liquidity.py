...
class Liquidity(BaseModel):
    ...
    constant_product: Optional[ConstantProductLiquidity] = Field(None, description="Constant product liquidity")
    weighted_product: Optional[WeightedProductLiquidity] = Field(None, description="Weighted product liquidity")
    stable: Optional[StableLiquidity] = Field(None, description="Stable liquidity")
    concentrated_liquidity: Optional[ConcentratedLiquidity] = Field(None, description="Concentrated liquidity")
    limit_order: Optional[LimitOrderLiquidity] = Field(None, description="Limit order liquidity")
